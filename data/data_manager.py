...
class DataManager:
    ...
    def initialize_project(self, project_dir: str) -> bool:
        ...
        try:
            ...
            (self.project_dir / 'data' / 'waveforms').mkdir(parents=True, exist_ok=True)
            (self.project_dir / 'data' / 'stations').mkdir(parents=True, exist_ok=True)
            (self.project_dir / 'data' / 'events').mkdir(parents=True, exist_ok=True)
